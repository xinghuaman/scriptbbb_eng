...
ramdisk(){
  ...
  echo -e " [5]  Ramdisk mode 1 - Squeezelite, Squeezelite-R2, Mpd, Networkaudiod (B)"
  echo -e " [6]  Ramdisk mode 2 - Squeezelite, Squeezelite-R2, Mpd, Networkaudiod, RoonBridge (B)"
  echo -e " \e[38;5;154m----------\e[0m"
